...
ErrorHandler:
    ...
    Private Sub frmMain_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
            'If Me.bNowConnected Then
            Me.iPhoneInterface.CloseConnect()
            'End If
    ...
    Private Sub connectionChange()
        If bConnectionChanged Then
            ...
            If bNowConnected Then
                ...
                Dim deviceName As String = iPhoneInterface.GetDeviceName()
                deviceName = IIf(String.IsNullOrEmpty(deviceName), String.Empty, " (" & deviceName & ")")
                Dim devStatus As String = String.Format("{0} {1}{2} is connected" & IIf(iPhoneInterface.IsJailbreak, " and jailbroken.", ", not jailbroken(no afc2)"), iPhoneInterface.GetDeviceInfo.Item("Model"), iPhoneInterface.GetDeviceVersion, deviceName)
